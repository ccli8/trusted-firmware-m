 ...
 *
 * Internal Flash:
 * 0x0000_0000 BL2 - MCUBoot (52KB)
 * 0x0000_D000 Protected Storage Area (52 KB)
...
#define FLASH_AREA_BL2_SIZE        (0xD000) /* 52 KB */

#if !defined(MCUBOOT_IMAGE_NUMBER) || (MCUBOOT_IMAGE_NUMBER == 1)
/* Secure + Non-secure image primary slot */
#define FLASH_AREA_0_ID            (1)
#define FLASH_AREA_0_OFFSET        (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE + 0x13000)  /* Reserved for storage */
...
#define FLASH_PS_AREA_SIZE              (0xD000)
